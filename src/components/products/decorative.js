...
const Decorative = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-gray-100 flex flex-col">
      {/* Hero Section */}
      <motion.div
      ...
      <section className="w-full bg-white px-4 sm:px-6 lg:px-20 py-6 sm:py-8">
        <div className="max-w-8xl mx-auto flex flex-col sm:flex-row items-start gap-4 sm:gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg text-gray-500">/ Decorative Lights</span>
          </div>

          {/* Description - Right Side */}
          <div className="flex-1 text-base sm:text-lg text-gray-700">
            Astra Decorative Lights combine elegance with modern lighting solutions, perfect for 
            enhancing any space with ambient illumination. Our collection features a variety of 
            stylish designs that blend functionality with aesthetic appeal, creating the perfect 
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
          ...
          <div className="w-full md:w-1/3">
            <input
              ...
              className="w-full p-2 sm:p-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition"
            />
          </div>
        </div>
                ...
                {Array.from({ length: totalCarousels }).map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full ${
                      index === currentCarousel ? "bg-yellow-500" : "bg-gray-300"
                    }`}
