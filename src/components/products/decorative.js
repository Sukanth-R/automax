  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        // Check cache
        const cachedData = localStorage.getItem('decorativeLights');
        const cacheTimestamp = localStorage.getItem('decorativeLightsTimestamp');
        ...
        setProducts(data.filter(p => p.category === "Decorative Lights"));
        localStorage.setItem('decorativeLights', JSON.stringify(data.filter(p => p.category === "Decorative Lights")));
        localStorage.setItem('decorativeLightsTimestamp', Date.now().toString());
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">DECORATIVE LIGHTS</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg text-gray-300">/ DECORATIVE LIGHTS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Decorative Lights combine elegance with modern lighting solutions, perfect for enhancing any space with ambient illumination. Our collection features a variety of stylish designs that blend functionality with aesthetic appeal, creating the perfect atmosphere for your home or business.
              </p>
            </div>
          </div>
        </div>
