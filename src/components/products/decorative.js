  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Cache keys specific for decorative
        ...
        // Change the category below to match your decorative products
        const filteredData = data.filter(p => p.category === "Decorative Lights");

        localStorage.setItem('decorativeLights', JSON.stringify(filteredData));
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-lg text-gray-300">/ DECORATIVE</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Decorative Lights add style and ambiance to any space. Discover our range of decorative lighting solutions for homes, events, and commercial spaces.
              </p>
            </div>
          </div>
        </div>
