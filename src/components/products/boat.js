...
const BOATLight = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-100 flex flex-col">
      {/* Hero Section */}
      <motion.div
      ...
      <section className="w-full bg-white px-4 sm:px-6 lg:px-20 py-6 sm:py-8">
        <div className="max-w-8xl mx-auto flex flex-col sm:flex-row items-start gap-4 sm:gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg text-gray-500">/ Boat Lights</span>
          </div>

          {/* Description - Right Side */}
          <div className="flex-1 text-base sm:text-lg text-gray-700">
            Astra Boat Lights are designed for marine environments, offering durability and 
            high-performance illumination for all your boating needs. These waterproof and 
            corrosion-resistant lights ensure safety and visibility in harsh marine conditions.
          </div>
        </div>
      </section>
