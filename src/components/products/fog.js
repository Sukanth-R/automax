...
const Fog = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100 flex flex-col relative overflow-hidden">
      {/* Hero Section */}
      <motion.div
      ...
      >
        <img
          ...
          alt="Fog Lights Banner"
          className="w-full h-full object-cover transform transition-transform duration-1000 hover:scale-105"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-blue-900/70 to-transparent flex items-center justify-center">
          <motion.h1
      ...
      <section className="w-full bg-white px-4 sm:px-6 lg:px-20 py-6 sm:py-8">
        <div className="max-w-8xl mx-auto flex flex-col sm:flex-row items-start gap-4 sm:gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg text-gray-500">/ Fog Lights</span>
          </div>

          {/* Description - Right Side */}
          <div className="flex-1 text-base sm:text-lg text-gray-700">
            Astra Fog Lights are designed for optimal visibility in challenging weather conditions. 
            These high-performance lights penetrate through fog, rain, and mist, providing enhanced 
            safety for your vehicle. Built with durable materials to withstand harsh environments.
          </div>
        </div>
      </section>
