      ...
      <section className="w-full bg-white px-4 sm:px-6 lg:px-20 py-6 sm:py-8">
        <div className="max-w-8xl mx-auto flex flex-col sm:flex-row items-start gap-4 sm:gap-8">
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={() => navigate('/')} 
              className="flex items-center gap-1 text-gray-700 hover:text-gray-600 transition-colors"
            >
              <Home className="h-5 w-5" />
              <span className="text-lg font-medium">Home</span>
            </button>
            <span className="text-lg text-gray-500">/ Roof Lamps</span>
          </div>

          {/* Description - Right Side */}
          <div className="flex-1 text-base sm:text-lg text-gray-700">
            Astra Roof Lamps provide powerful illumination for industrial and commercial spaces. 
            Designed for durability and high performance, these lamps offer superior light 
            distribution for warehouses, factories, and large indoor areas. Built to withstand 
            demanding environments with long-lasting reliability.
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
          ...
          <div className="w-full md:w-1/3">
            <input
              ...
              className="w-full p-2 sm:p-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition"
            />
          </div>
        </div>
                ...
                {Array.from({ length: totalCarousels }).map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full ${
                      index === currentCarousel ? "bg-gray-500" : "bg-gray-300"
                    }`}
