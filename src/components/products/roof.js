  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Cache keys specific for roof
        const cachedData = localStorage.getItem('roofLights');
        const cacheTimestamp = localStorage.getItem('roofLightsTimestamp');
        ...
        // Change the category below to match your roof products
        const filteredData = data.filter(p => p.category === "Roof Lamps");

        localStorage.setItem('roofLights', JSON.stringify(filteredData));
        localStorage.setItem('roofLightsTimestamp', Date.now().toString());
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">ROOF LIGHTS</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-lg text-gray-300">/ ROOF LIGHTS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Roof Lights provide powerful illumination and style for vehicles. Browse our selection of durable and efficient roof lighting solutions.
              </p>
            </div>
          </div>
        </div>
