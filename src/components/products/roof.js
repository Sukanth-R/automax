  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const filtered = data.filter(p => p.category === "Roof Lamps");
        localStorage.setItem('roofLights', JSON.stringify(filtered));
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">ROOF LAMPS</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg text-gray-300">/ ROOF LAMPS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Roof Lamps provide powerful illumination for industrial and commercial spaces. Designed for durability and high performance, these lamps offer superior light distribution for warehouses, factories, and large indoor areas. Built to withstand demanding environments with long-lasting reliability.
              </p>
            </div>
          </div>
        </div>
