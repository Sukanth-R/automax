  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Cache keys specific for converters
        ...
        // Change the category below to match your converter products
        const filteredData = data.filter(p => p.category === "Converters");

        localStorage.setItem('converters', JSON.stringify(filteredData));
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-lg text-gray-300">/ CONVERTERS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Converters provide reliable voltage conversion for a variety of automotive and industrial applications. Explore our range to find the right converter for your needs.
              </p>
            </div>
          </div>
        </div>
