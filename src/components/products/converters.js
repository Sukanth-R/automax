      ...
      <section className="w-full bg-white px-4 sm:px-6 lg:px-20 py-6 sm:py-8">
        <div className="max-w-8xl mx-auto flex flex-col sm:flex-row items-start gap-4 sm:gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg text-gray-500">/ Converters</span>
          </div>

          {/* Description - Right Side */}
          <div className="flex-1 text-base sm:text-lg text-gray-700">
            Astra Converters are designed for efficient power conversion, offering reliable 
            performance for various electrical applications. Our converters ensure stable 
            voltage transformation with high efficiency and durability for both residential 
            and industrial use.
          </div>
        </div>
      </section>
