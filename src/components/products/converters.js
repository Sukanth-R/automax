  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        // Check cache
        const cachedData = localStorage.getItem('converters');
        const cacheTimestamp = localStorage.getItem('convertersTimestamp');
        ...
        const filtered = data.filter(p => p.category === "Converters");
        localStorage.setItem('converters', JSON.stringify(filtered));
        localStorage.setItem('convertersTimestamp', Date.now().toString());
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">CONVERTERS</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg text-gray-300">/ CONVERTERS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Converters are designed for efficient power conversion, offering reliable performance for various electrical applications. Our converters ensure stable voltage transformation with high efficiency and durability for both residential and industrial use.
              </p>
            </div>
          </div>
        </div>
