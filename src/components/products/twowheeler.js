  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const filtered = data.filter(p => p.category === "Two Wheeler Lights");
        localStorage.setItem('twowheelerLights', JSON.stringify(filtered));
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg text-gray-300">/ TWO WHEELER LIGHTS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Two Wheeler Lights are designed specifically for motorcycles and scooters, offering superior visibility and safety. These durable lights are built to withstand the vibrations and weather conditions of two-wheeler use while providing optimal illumination for night riding.
              </p>
            </div>
          </div>
        </div>
