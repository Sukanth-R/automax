  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Cache keys specific for twowheeler
        const cachedData = localStorage.getItem('twowheelerLights');
        const cacheTimestamp = localStorage.getItem('twowheelerLightsTimestamp');
        ...
        // Change the category below to match your two wheeler products
        const filteredData = data.filter(p => p.category === "Two Wheeler Lights");

        localStorage.setItem('twowheelerLights', JSON.stringify(filteredData));
        localStorage.setItem('twowheelerLightsTimestamp', Date.now().toString());
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">TWO WHEELER LIGHTS</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-lg text-gray-300">/ TWO WHEELER LIGHTS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Two Wheeler Lights are designed for motorcycles and scooters, offering reliable performance and style. Browse our selection for the perfect fit for your ride.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 bg-white relative">
        ...
        {/* Error State */}
        {fetchError && (
          <div className="flex flex-col items-center justify-center py-12 bg-gray-50 rounded-lg mt-6">
