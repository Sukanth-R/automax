  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Cache keys specific for side
        const cachedData = localStorage.getItem('sideIndicators');
        const cacheTimestamp = localStorage.getItem('sideIndicatorsTimestamp');
        ...
        // Change the category below to match your side products
        const filteredData = data.filter(p => p.category === "Side Indicators");

        localStorage.setItem('sideIndicators', JSON.stringify(filteredData));
        localStorage.setItem('sideIndicatorsTimestamp', Date.now().toString());
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">SIDE LIGHTS</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-lg text-gray-300">/ SIDE LIGHTS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Side Lights offer enhanced visibility and style for your vehicle. Explore our range of durable and efficient side lighting solutions.
              </p>
            </div>
          </div>
        </div>
