  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Cache keys specific for tail
        const cachedData = localStorage.getItem('tailLamps');
        const cacheTimestamp = localStorage.getItem('tailLampsTimestamp');
        ...
        // Change the category below to match your tail products
        const filteredData = data.filter(p => p.category === "Tail Lamp Assembly");

        localStorage.setItem('tailLamps', JSON.stringify(filteredData));
        localStorage.setItem('tailLampsTimestamp', Date.now().toString());
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">TAIL LIGHTS</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm sm:text-lg text-gray-300">/ TAIL LIGHTS</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Tail Lights combine safety and style for your vehicle. Explore our range of reliable and attractive tail lighting solutions.
              </p>
            </div>
          </div>
        </div>
