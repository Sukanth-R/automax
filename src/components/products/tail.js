  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const filtered = data.filter(p => p.category === "Tail Lamp Assembly");
        localStorage.setItem('tailLamps', JSON.stringify(filtered));
        ...
        <div className="container mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            <div className="lg:w-1/3 mb-8 lg:mb-0">
              ...
              <p className="text-sm uppercase text-white mb-2">TAIL LAMP ASSEMBLY</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg text-gray-300">/ TAIL LAMP ASSEMBLY</span>
              </div>
            </div>
            <div className="lg:w-2/3">
              ...
              <p className="text-sm sm:text-base mb-6 text-gray-200">
                Astra Tail Lamp Assemblies combine style with functionality, providing optimal visibility and safety for your vehicle. These durable assemblies are designed to withstand harsh weather conditions while maintaining their aesthetic appeal and performance.
              </p>
            </div>
          </div>
        </div>
